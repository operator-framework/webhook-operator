...
type WebhookTest struct {
	...
	// spec defines the desired state of WebhookTest
	// +required
	Spec WebhookTestSpec `json:"spec"`

	// status defines the observed state of WebhookTest
	// +optional
	Status WebhookTestStatus `json:"status,omitempty,omitzero"`
}
